	...
	public DataSetMunicipios( String nombreFichero ) throws IOException {
		...
		while (lecturaFic.hasNextLine()) {
			...
			try {
				...
				int densidad = Integer.parseInt( partes[5] );
				int lluvia = Integer.parseInt( partes[6] );
				Municipio muni = new Municipio( codigo, nombre, habitantes, provincia, comunidad ,densidad, lluvia);
